...
class Menu {
  ...
  public static function listAll($siteId) {
    ...
    $dir = APP_ROOT.'/public/sites/'.$siteId.'/data/menus/';
    $exts = array('json');
  ...
  public static function getById($id, $siteId) {
    ...
    $file = APP_ROOT.'/public/sites/'.$siteId.'/data/menus/'.$id.'.json';
  ...
  public static function add($name, $siteId) {
    ...
    $x = 1;
    $folder = APP_ROOT.'/public/sites/'.$siteId.'/data/menus/'.$id.'.json';

    while(file_exists($folder) === TRUE) {

      // increment id and folder
      $new_id = $id.$x;
      $folder = APP_ROOT.'/public/sites/'.$siteId.'/data/menus/'.$new_id.'.json';
      $x++;
    ...
    // get file
    $dir = APP_ROOT.'/public/sites/'.$siteId.'/data/menus/';
    $file = APP_ROOT.'/public/sites/'.$siteId.'/data/menus/'.$new_id.'.json';
  ...
  public function save($siteId) {
    ...
    // get file
    $file = APP_ROOT.'/public/sites/'.$siteId.'/data/menus/'.$this->id.'.json';
