...
class Form {
  ...
  public static function listAll($siteId) {
    ...
    $dir = APP_ROOT.'/public/sites/'.$siteId.'/data/forms/';
    $exts = array('json');
  ...
  public static function getById($id, $siteId) {
    ...
    $file = APP_ROOT.'/public/sites/'.$siteId.'/data/forms/'.$id.'.json';
  ...
  public static function add($name, $cssClass, $validate, $success, $error, $recaptchaError, $notify, $siteId) {
    ...
    $x = 1;
    $folder = APP_ROOT.'/public/sites/'.$siteId.'/data/forms/'.$id.'.json';

    while(file_exists($folder) === TRUE) {

      // increment id and folder
      $new_id = $id.$x;
      $folder = APP_ROOT.'/public/sites/'.$siteId.'/data/forms/'.$new_id.'.json';
      $x++;
    ...
    // get file
    $dir = APP_ROOT.'/public/sites/'.$siteId.'/data/forms/';
    $file = APP_ROOT.'/public/sites/'.$siteId.'/data/forms/'.$new_id.'.json';
  ...
  public function save($siteId) {
    ...
    // get file
    $file = APP_ROOT.'/public/sites/'.$siteId.'/data/forms/'.$this->id.'.json';
