...
class User {
   ...
   */
	public static function getUsers($id) {
  	...
  	$file = APP_ROOT.'/resources/sites/'.$id.'/users.json';
  ...
  public function save($id) {
    ...
    // defaults
    $dir = APP_ROOT.'/resources/sites/'.$id.'/';
    $is_match = false;
  ...
  public function remove($id){
    ...
    $json_file = APP_ROOT.'/resources/sites/'.$id.'/users.json';
   ...
   */
    ...
    foreach($sites as &$site) {
      ...
      // get base path for the site
      $json_file = APP_ROOT.'/resources/sites/'.$site.'/users.json';
