...
class Site {
  ...
  public function save() {
    ...
    $dir = APP_ROOT.'/resources/sites/'.$this->id.'/';
   ...
   */
    ...
    $file = APP_ROOT.'/resources/sites/'.$id.'/site.json';
   ...
   */
    ...
    $x = 1;
    $folder = APP_ROOT.'/public/sites/'.$id;

    while(file_exists($folder) === TRUE) {

      // increment id and folder
      $new_id = $id.$x;
      $folder = APP_ROOT.'/public/sites/'.$new_id;
      $x++;
