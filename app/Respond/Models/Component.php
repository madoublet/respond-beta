...
class Component {
  ...
  public static function add($data, $site, $user, $content = NULL){
    ...
    if($content == NULL) {
      ...
      // get template
      $template_file = APP_ROOT.'/public/sites/'.$site->id.'/templates/default.html';
  ...
  public static function remove($url, $user, $site){
    ...
    $component = APP_ROOT.'/public/sites/'.$site->id.'/components/'.$url;
  ...
  public static function listAll($siteId){
    ...
    // set dir
    $dir = APP_ROOT.'/public/sites/'.$siteId.'/components';
